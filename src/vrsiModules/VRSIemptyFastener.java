...
public class VRSIemptyFastener {
	...
	public String toString() {
		return "VRSIemptyFastenerData: [holeID=" + holeID + "\npinDiameter="
				+ pinDiameter + "\npinMaximumDepth=" + pinMaximumDepth
				+ "\npinMinimumDepth=" + pinMinimumDepth + "\npinAverageDepth="
				+ pinAverageDepth + "\nfillVolume=" + fillVolume + ", posX="
				+ posX + ", posY=" + posY + ", posZ=" + posZ + "\nrotC=" + rotC
				+ ", rotB=" + rotB + ", rotA=" + rotA + "]";
	}
