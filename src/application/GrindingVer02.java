 ...
 * @see #dispose()
 */
public class GrindingVer02 extends RoboticsAPIApplication {
	@Inject
	private LBR bot;
	...
	public ArrayList<Frame> handGuideRecord(Frame zoneSafePos, boolean manualGrinding) {
		...
		while (!recPositionDone) {
			...
			//set at standstill and wait for graing handle and moving
			...
			handPos = bot.getCurrentCartesianPosition(currentTCP, nullBase).copy();
			positionHoldContainer.cancel();
