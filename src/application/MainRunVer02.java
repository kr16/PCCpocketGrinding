 ...
 * @see #dispose()
 */
public class MainRunVer02 extends RoboticsAPIApplication {
	@Inject
	...
	public void run() {
		...
		//DispenserThread = new Thread(dispenser2);
		//DispenserThread.start();
		System.out.println(coupon.getFirstNotProcessed(EHotDotCouponStates.Skip));
		System.out.println(coupon.getFirstNotProcessed(EHotDotCouponStates.Empty));
		System.out.println(coupon.getFirstNotProcessed(EHotDotCouponStates.Error));
...
//	}
	...
	public static void main(String[] args) {
		MainRunVer02 app = new MainRunVer02();
		app.runApplication();
	}
}
